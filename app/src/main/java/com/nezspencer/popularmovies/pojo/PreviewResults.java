...
public class PreviewResults implements Parcelable {
    public static final Creator<PreviewResults> CREATOR = new Creator<PreviewResults>() {
        @Override
        public PreviewResults createFromParcel(Parcel source) {
            PreviewResults var = new PreviewResults();
        ...
        @Override
        public PreviewResults[] newArray(int size) {
            return new PreviewResults[size];
        }
    };
    private String site;
    private int size;
